...
public class FileUploadOperation {
    ...
    public void start() {
        ...
        Utilities.stageQueue.postRunnable(() -> {
            ...
            slowNetwork = YuurigramCoreConfig.INSTANCE.getSlowNetworkMode();
...
//                }
                ...
                uploadChunkSize = (int) Math.max(slowNetwork ? minUploadChunkSlowNetworkSize : YuurigramCoreConfig.INSTANCE.getUploadSpeedBoost() ? minUploadChunkSizeBoost : minUploadChunkSize, (totalFileSize + 1024L * maxUploadParts - 1) / (1024L * maxUploadParts));
