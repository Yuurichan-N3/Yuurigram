...
package id.idn.yuurigram.preferences.helpers;
...
import id.idn.yuurigram.preferences.cells.StickerSliderCell;
...
public class AlertDialogSwitchers {
    ...
    public static void showMessageSize(BaseFragment fragment) {
        ...
        largerVoiceMessagesLayout.setTextAndValueAndCheck(getString(R.string.CP_LargeVoiceMessages), getString(R.string.CP_LargeVoiceMessages_Desc), YuurigramMessagesConfig.INSTANCE.getLargerVoiceMessagesLayout(), true, true);
        largerVoiceMessagesLayout.setOnClickListener(v -> {
            YuurigramMessagesConfig.INSTANCE.setLargerVoiceMessagesLayout(!YuurigramMessagesConfig.INSTANCE.getLargerVoiceMessagesLayout());
            ...
            switch (a) {
                case 0: {
                    ...
                    contract = new StickerSliderCell.TGSLContract() {
                        ...
                        public void setValue(int value) {
                            YuurigramMessagesConfig.INSTANCE.setSlider_mediaAmplifier(value);
                        }

                        @Override
                        public int getPreferenceValue() {
                            return YuurigramMessagesConfig.INSTANCE.getSlider_mediaAmplifier();
                        }
                    ...
                    contract.setValue(YuurigramMessagesConfig.INSTANCE.getSlider_mediaAmplifier());
                ...
                case 1: {
                    ...
                    contract = new StickerSliderCell.TGSLContract() {
                        @Override
                        public void setValue(int value) {
                            YuurigramMessagesConfig.INSTANCE.setSlider_stickerAmplifier(value);
                        }

                        @Override
                        public int getPreferenceValue() {
                            return YuurigramMessagesConfig.INSTANCE.getSlider_stickerAmplifier();
                        }
                    ...
                    contract.setValue(YuurigramMessagesConfig.INSTANCE.getSlider_stickerAmplifier());
                    stickerSliderCell.setContract(contract);
                    break;
                }
                case 2: {
                    ...
                    contract = new StickerSliderCell.TGSLContract() {
                        @Override
                        public void setValue(int value) {
                            YuurigramMessagesConfig.INSTANCE.setSlider_gifsAmplifier(value);
                        }

                        @Override
                        public int getPreferenceValue() {
                            return YuurigramMessagesConfig.INSTANCE.getSlider_gifsAmplifier();
                        }
                    ...
                    contract.setValue(YuurigramMessagesConfig.INSTANCE.getSlider_gifsAmplifier());
                    stickerSliderCell.setContract(contract);
                    break;
                }
            }
            ...
            switch (a) {
                case 0: {
                    ...
                    contract = new StickerSliderCell.TGSLContract() {
                        @Override
                        public void setValue(int value) {
                            YuurigramChatsConfig.INSTANCE.setSlider_RecentEmojisAmplifier(value);
                        }

                        @Override
                        public int getPreferenceValue() {
                            return YuurigramChatsConfig.INSTANCE.getSlider_RecentEmojisAmplifier();
                        }
                    ...
                    contract.setValue(YuurigramChatsConfig.INSTANCE.getSlider_RecentEmojisAmplifier());
                    stickerSliderCell.setContract(contract);
                    break;
                }
                case 1: {
                    ...
                    contract = new StickerSliderCell.TGSLContract() {
                        @Override
                        public void setValue(int value) {
                            YuurigramChatsConfig.INSTANCE.setSlider_RecentStickersAmplifier(value);
                        }

                        @Override
                        public int getPreferenceValue() {
                            return YuurigramChatsConfig.INSTANCE.getSlider_RecentStickersAmplifier();
                        }
                    ...
                    contract.setValue(YuurigramChatsConfig.INSTANCE.getSlider_RecentStickersAmplifier());
                    stickerSliderCell.setContract(contract);
                    break;
                }
            }
