    ...
    public View createView(Context context) {
        ...
        listView.setOnItemClickListener((view, position, x, y) -> {
            ...
            if (position == brandedScreenshotsSwitchRow) {
                YuurigramCoreConfig.INSTANCE.setCgBrandedScreenshots(!YuurigramCoreConfig.INSTANCE.getCgBrandedScreenshots());
                if (view instanceof TextCheckCell) {
                    ((TextCheckCell) view).setChecked(YuurigramCoreConfig.INSTANCE.getCgBrandedScreenshots());
                }
                CGBulletinCreator.INSTANCE.createRestartBulletin(this);
            } else if (position == rateUsRow) {
                YuurigramExtras.INSTANCE.requestReviewFlow(this);
...
//        private final int VIEW_TYPE_TEXT_DETAIL_SETTINGS = 6;
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            switch (holder.getItemViewType()) {
                ...
                case VIEW_TYPE_TEXT_CHECK: {
                    ...
                    if (position == brandedScreenshotsSwitchRow) {
                        textCheckCell.setTextAndCheck(getString(R.string.DP_CameraCutout), YuurigramCoreConfig.INSTANCE.getCgBrandedScreenshots(), false);
                    }
                    break;
                }
                ...
                case VIEW_TYPE_TABLE: {
                    ...
                    if (position == stickerTableInfoRow) {
                        ...
                        CharSequence moreInfoText = AndroidUtilities.replaceSingleTag(getString(R.string.DP_DonatesMoreInfo),
                                Theme.key_windowBackgroundWhiteLinkText,
                                AndroidUtilities.REPLACING_TAG_TYPE_LINKBOLD,
                                () -> Browser.openUrl(getContext(), "https://t.me/YuurigramSupport")
                        );
    ...
    private SpannableStringBuilder generateDescForDonates(TableView tableView) {
        ...
        CharSequence compactMessageMenuText = AndroidUtilities.replaceSingleTag(getString(R.string.DP_Donate_MsgMenuCompactView_Desc),
                Theme.key_windowBackgroundWhiteLinkText,
                AndroidUtilities.REPLACING_TAG_TYPE_LINKBOLD,
                () -> YuurigramPreferencesNavigator.INSTANCE.createMessageMenu(DonatesPreferencesEntry.this)
        );

        CharSequence foldersAtTheBottomText = AndroidUtilities.replaceSingleTag(getString(R.string.DP_Donate_FoldersAtBottom_Desc),
                Theme.key_windowBackgroundWhiteLinkText,
                AndroidUtilities.REPLACING_TAG_TYPE_LINKBOLD,
                () -> YuurigramPreferencesNavigator.INSTANCE.createFoldersPrefs(DonatesPreferencesEntry.this)
        );
    ...
    private SpannableStringBuilder generateDescForMarketplace(TableView tableView) {
        ...
        CharSequence filterText = AndroidUtilities.replaceSingleTag(getString(R.string.DP_Donate_MessageFilter_Desc),
                Theme.key_windowBackgroundWhiteLinkText,
                AndroidUtilities.REPLACING_TAG_TYPE_LINKBOLD,
                () -> YuurigramPreferencesNavigator.INSTANCE.createMessageFilter(DonatesPreferencesEntry.this)
        );
