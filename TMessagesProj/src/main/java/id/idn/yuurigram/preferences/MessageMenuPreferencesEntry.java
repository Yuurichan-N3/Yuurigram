    ...
    public View createView(Context context) {
        ...
        listView.setOnItemClickListener((view, position, x, y) -> {
            ...
            if (position == enableNewMessageMenuRow) {
                YuurigramMessagesConfig.INSTANCE.setBlurMessageMenuBackground(!YuurigramMessagesConfig.INSTANCE.getBlurMessageMenuBackground());
                if (view instanceof TextCheckCell) {
                    ((TextCheckCell) view).setChecked(YuurigramMessagesConfig.INSTANCE.getBlurMessageMenuBackground());
                }
                ...
                YuurigramMessagesConfig.INSTANCE.setMsgMenuUnifiedScroll(!YuurigramMessagesConfig.INSTANCE.getMsgMenuUnifiedScroll());
                if (view instanceof TextCheckCell) {
                    ((TextCheckCell) view).setChecked(YuurigramMessagesConfig.INSTANCE.getMsgMenuUnifiedScroll());

                    /*if (YuurigramMessagesConfig.INSTANCE.getMsgMenuUnifiedScroll() && !YuurigramMessagesConfig.INSTANCE.getBlurMessageMenuBackground()) {
                        YuurigramMessagesConfig.INSTANCE.setBlurMessageMenuBackground(true);
                        listAdapter.notifyItemChanged(enableNewMessageMenuRow, false);
                    }

                    YuurigramMessagesConfig.INSTANCE.setMsgMenuFixedHeight(!YuurigramMessagesConfig.INSTANCE.getMsgMenuUnifiedScroll() || !YuurigramMessagesConfig.INSTANCE.getMsgMenuFixedHeight());*/

                    listAdapter.notifyItemChanged(autoScrollMessagesRow, false);
                    listAdapter.notifyItemChanged(fixedMessageHeightRow, false);
                }
            } else if (position == autoScrollMessagesRow) {
                YuurigramMessagesConfig.INSTANCE.setMsgMenuAutoScroll(!YuurigramMessagesConfig.INSTANCE.getMsgMenuAutoScroll());
                if (view instanceof TextCheckCell) {
                    ((TextCheckCell) view).setChecked(YuurigramMessagesConfig.INSTANCE.getMsgMenuAutoScroll());

                    if (YuurigramMessagesConfig.INSTANCE.getMsgMenuAutoScroll() && !YuurigramMessagesConfig.INSTANCE.getBlurMessageMenuBackground()) {
                        YuurigramMessagesConfig.INSTANCE.setBlurMessageMenuBackground(true);
                        listAdapter.notifyItemChanged(enableNewMessageMenuRow, false);
                    }
                }
            } else if (position == fixedMessageHeightRow) {
                YuurigramMessagesConfig.INSTANCE.setMsgMenuFixedHeight(!YuurigramMessagesConfig.INSTANCE.getMsgMenuFixedHeight());
                if (view instanceof TextCheckCell) {
                    ((TextCheckCell) view).setChecked(YuurigramMessagesConfig.INSTANCE.getMsgMenuFixedHeight());

                    if (YuurigramMessagesConfig.INSTANCE.getMsgMenuFixedHeight() && !YuurigramMessagesConfig.INSTANCE.getBlurMessageMenuBackground()) {
                        YuurigramMessagesConfig.INSTANCE.setBlurMessageMenuBackground(true);
                        listAdapter.notifyItemChanged(enableNewMessageMenuRow, false);
                    }
                }
            } else if (position == blurMessageMenuItemsRow) {
                YuurigramMessagesConfig.INSTANCE.setBlurMessageMenuItems(!YuurigramMessagesConfig.INSTANCE.getBlurMessageMenuItems());
                if (view instanceof TextCheckCell) {
                    ((TextCheckCell) view).setChecked(YuurigramMessagesConfig.INSTANCE.getBlurMessageMenuItems());

                    if (YuurigramMessagesConfig.INSTANCE.getBlurMessageMenuItems() && !YuurigramMessagesConfig.INSTANCE.getBlurMessageMenuBackground()) {
                        YuurigramMessagesConfig.INSTANCE.setBlurMessageMenuBackground(true);
                        listAdapter.notifyItemChanged(enableNewMessageMenuRow, false);
                    }
                }
            } else if (position == useNativeBlurRow) {
                YuurigramMessagesConfig.INSTANCE.setMsgMenuNativeBlur(!YuurigramMessagesConfig.INSTANCE.getMsgMenuNativeBlur());
                if (view instanceof TextCheckCell) {
                    ((TextCheckCell) view).setChecked(YuurigramMessagesConfig.INSTANCE.getMsgMenuNativeBlur());

                    if (YuurigramMessagesConfig.INSTANCE.getMsgMenuNativeBlur() && !YuurigramMessagesConfig.INSTANCE.getBlurMessageMenuBackground()) {
                        YuurigramMessagesConfig.INSTANCE.setBlurMessageMenuBackground(true);
                        listAdapter.notifyItemChanged(enableNewMessageMenuRow, false);
                    }
                }
                ...
                YuurigramMessagesConfig.INSTANCE.setMsgMenuItemsCompactView(!YuurigramMessagesConfig.INSTANCE.getMsgMenuItemsCompactView());
                if (view instanceof TextCheckCell) {
                    ((TextCheckCell) view).setChecked(YuurigramMessagesConfig.INSTANCE.getMsgMenuItemsCompactView());
                }
            }
        });
                ...
                case VIEW_TYPE_TEXT_CHECK:
                    ...
                    if (position == enableNewMessageMenuRow) {
                        ...
                        textCheckCell.setTextAndValueAndCheck(
                                ...
                                YuurigramMessagesConfig.INSTANCE.getBlurMessageMenuBackground(),
                                true,
                                true
                        );
                    } else if (position == unifiedScrollRow) {
                        textCheckCell.setEnabled(YuurigramMessagesConfig.INSTANCE.getBlurMessageMenuBackground(), null);
                        textCheckCell.setTextAndValueAndCheck(
                                getString(R.string.CP_MessageMenuUnifiedScroll),
                                getString(R.string.CP_MessageMenuUnifiedScroll_Desc),
                                YuurigramMessagesConfig.INSTANCE.getMsgMenuUnifiedScroll(),
                                true,
                                true
                        );
                    } else if (position == autoScrollMessagesRow) {
                        textCheckCell.setEnabled(YuurigramMessagesConfig.INSTANCE.getBlurMessageMenuBackground() && !YuurigramMessagesConfig.INSTANCE.getMsgMenuUnifiedScroll(), null);
                        textCheckCell.setTextAndValueAndCheck(
                                getString(R.string.CP_MessageMenuAutoscroll),
                                getString(R.string.CP_MessageMenuAutoscroll_Desc),
                                YuurigramMessagesConfig.INSTANCE.getMsgMenuAutoScroll(),
                                true,
                                true
                        );
                    } else if (position == fixedMessageHeightRow) {
                        ...
                        textCheckCell.setTextAndValueAndCheck(
                                ...
                                YuurigramMessagesConfig.INSTANCE.getMsgMenuFixedHeight(),
                                true,
                                true
                        );
                    } else if (position == blurMessageMenuItemsRow) {
                        ...
                        textCheckCell.setTextAndValueAndCheck(
                                ...
                                YuurigramMessagesConfig.INSTANCE.getBlurMessageMenuItems(),
                                true,
                                true
                        );
                    } else if (position == useNativeBlurRow) {
                        ...
                        textCheckCell.setTextAndValueAndCheck(
                                ...
                                YuurigramMessagesConfig.INSTANCE.getMsgMenuNativeBlur(),
                                true,
                                false
                        );
                    } else if (position == messageMenuItemsCompactView) {
                        ...
                        textCheckCell.setTextAndValueAndCheck(
                                ...
                                YuurigramMessagesConfig.INSTANCE.getMsgMenuItemsCompactView(),
                                true,
                                false
                        );
                    }
