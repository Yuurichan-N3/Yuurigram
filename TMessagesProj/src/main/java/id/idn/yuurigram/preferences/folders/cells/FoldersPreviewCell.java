...
public class FoldersPreviewCell extends FrameLayout {
    ...
    public void updateTabTitle(boolean animate) {
        float to = YuurigramAppearanceConfig.INSTANCE.getTabMode() != 2 ? 1 : 0;
    ...
    public void updateTabIcons(boolean animate) {
        float to = YuurigramAppearanceConfig.INSTANCE.getTabMode() != 1 ? 1 : 0;
    ...
    public void updateTabCounter(boolean animate) {
        float to = !YuurigramAppearanceConfig.INSTANCE.getTabsNoUnread() ? 1 : 0;
    ...
    private String getAllChatsTabName() {
        return YuurigramAppearanceConfig.INSTANCE.getTabsHideAllChats() ? filters[6][0] : filters[0][0];
    }

    private String getAllChatsTabIcon() {
        return YuurigramAppearanceConfig.INSTANCE.getTabsHideAllChats() ? filters[6][1] : filters[0][1];
    }
