...
//        folderIcons.put("\uD83D\uDCA1", R.drawable.filter_light_solar2);
    ...
    public static int getPadding() {
        if (YuurigramAppearanceConfig.INSTANCE.getTabMode() == YuurigramAppearanceConfig.TAB_TYPE_MIX) {
    ...
    public static int getTotalIconWidth() {
        int result = 0;
        if (YuurigramAppearanceConfig.INSTANCE.getTabMode() != YuurigramAppearanceConfig.TAB_TYPE_TEXT) {
    ...
    public static int getInternalPaddingTab() {
        /*if (YuurigramAppearanceConfig.INSTANCE.getTabMode() != YuurigramAppearanceConfig.TAB_TYPE_ICON) {
