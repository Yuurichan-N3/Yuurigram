...
import uz.unnarsx.yuurigram.core.helpers.backup.BackupHelper;
...
//        items.add(UItem.asButton(experimentalRow, R.drawable.msg_fave_solar, getString(R.string.EP_Category_Experimental)));
    ...
    protected void onClick(UItem item, View view, int position, float x, float y) {
        if (item.id == generalRow) {
            YuurigramPreferencesNavigator.INSTANCE.createGeneral(this);
        } else if (item.id == appearanceRow) {
            YuurigramPreferencesNavigator.INSTANCE.createAppearance(this);
        } else if (item.id == chatsRow) {
            YuurigramPreferencesNavigator.INSTANCE.createChats(this);
        } else if (item.id == cameraRow) {
            YuurigramPreferencesNavigator.INSTANCE.createCamera(this);
        } else if (item.id == experimentalRow) {
            YuurigramPreferencesNavigator.INSTANCE.createExperimental(this);
        } else if (item.id == privacyRow) {
            YuurigramPreferencesNavigator.INSTANCE.createPrivacy(this);
        } else if (item.id == supportRow) {
            YuurigramPreferencesNavigator.INSTANCE.createDonate(this);
            ...
            YuurigramPreferencesNavigator.INSTANCE.createAbout(this);
        }
    }
