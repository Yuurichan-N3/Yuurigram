...
object CGResourcesHelper {
    ...
    fun getAppName(): String {
        if (YuurigramCoreConfig.isStandaloneStableBuild() || YuurigramCoreConfig.isPlayStoreBuild()) {
            return "Yuurigram"
        } else if (YuurigramCoreConfig.isStandaloneBetaBuild()) {
            return "Yuurigram Beta"
        } else if (YuurigramCoreConfig.isStandalonePremiumBuild()) {
            return "Yuurigram Premium"
        } else if (YuurigramCoreConfig.isDevBuild()) {
            return "Yuurigram Dev"
        }
    ...
    fun getBuildType(): String {
        if (YuurigramCoreConfig.isStandaloneStableBuild()) {
            return getString(R.string.UP_BTRelease)
        } else if (YuurigramCoreConfig.isPlayStoreBuild()) {
            return "Play Store"
        } else if (YuurigramCoreConfig.isStandaloneBetaBuild()) {
    ...
    fun getLeftButtonText(noForwards: Boolean): String {
        ...
        return when (YuurigramMessagesConfig.leftBottomButton) {
            YuurigramMessagesConfig.LEFT_BUTTON_REPLY -> getString(R.string.Reply)
            YuurigramMessagesConfig.LEFT_BUTTON_SAVE_MESSAGE -> getString(R.string.CG_ToSaved)
            YuurigramMessagesConfig.LEFT_BUTTON_DIRECT_SHARE -> getString(R.string.DirectShare)
            YuurigramMessagesConfig.LEFT_BUTTON_FORWARD_WO_AUTHORSHIP -> capitalize(getString(R.string.CG_Without_Authorship))
    ...
    fun getLeftButtonDrawable(noForwards: Boolean): Int {
        ...
        return when (YuurigramMessagesConfig.leftBottomButton) {
            YuurigramMessagesConfig.LEFT_BUTTON_REPLY -> R.drawable.input_reply
            YuurigramMessagesConfig.LEFT_BUTTON_SAVE_MESSAGE -> R.drawable.msg_saved
            YuurigramMessagesConfig.LEFT_BUTTON_DIRECT_SHARE -> R.drawable.msg_share
            else -> R.drawable.input_reply
        }
    }

    fun getReplyIconDrawable(): Int {
        return when (YuurigramMessagesConfig.messageSlideAction) {
            YuurigramMessagesConfig.MESSAGE_SLIDE_ACTION_SAVE -> R.drawable.msg_saved_filled_solar
            YuurigramMessagesConfig.MESSAGE_SLIDE_ACTION_DIRECT_SHARE -> R.drawable.msg_share_filled
            YuurigramMessagesConfig.MESSAGE_SLIDE_ACTION_TRANSLATE -> R.drawable.msg_translate_filled_solar
            YuurigramMessagesConfig.MESSAGE_SLIDE_ACTION_TRANSLATE_GEMINI -> R.drawable.msg_translate_filled_solar
    ...
    fun getProperNotificationIcon(): Int { // App notification icon
        return if (YuurigramCoreConfig.oldNotificationIcon) {
    ...
    fun getResidentNotificationIcon(): Int {
        return if (YuurigramCoreConfig.oldNotificationIcon) R.drawable.cg_notification else R.drawable.notification
    }
