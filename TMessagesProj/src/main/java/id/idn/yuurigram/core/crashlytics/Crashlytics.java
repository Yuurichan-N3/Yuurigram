...
public class Crashlytics implements Thread.UncaughtExceptionHandler {
    ...
    public static String getReportMessage() {
        return  "Steps to reproduce:\n" +
                ...
                "Details:\n"+
                "• Yuurigram Version: " + CGResourcesHelper.getCherryVersion() + " (" + CGResourcesHelper.getAbiCode() + ")\n" +
                ...
                "• Camera: " + CameraPreferencesEntry.getCameraName() + "Dual: " + YuurigramCameraConfig.INSTANCE.getUseDualCamera() + "\n" +
