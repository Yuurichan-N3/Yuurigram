...
abstract public class BaseTranslator {
    ...
    public String getCurrentTargetLanguage() {
        return getTargetLanguage(YuurigramMessagesConfig.INSTANCE.getTranslationTarget());
    }

    public String getCurrentTargetKeyboardLanguage() {
        return getTargetLanguage(YuurigramMessagesConfig.INSTANCE.getTranslationKeyboardTarget());
    }
