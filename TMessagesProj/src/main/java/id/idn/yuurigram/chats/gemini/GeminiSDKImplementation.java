...
public class GeminiSDKImplementation {
    ...
    public static void initGeminiConfig(
        ...
        configBuilder.temperature = (float) YuurigramMessagesConfig.INSTANCE.getGeminiTemperatureValue() / 10;
    ...
    private static void createGenerativeModel(
        ...
        GenerativeModel gm = new GenerativeModel(
                YuurigramMessagesConfig.INSTANCE.getGeminiModelName(),
        ...
        Futures.addCallback(response, new FutureCallback<>() {
            ...
            public void onSuccess(GenerateContentResponse result) {
                if (result.getText() != null) {
                    ...
                    if (YuurigramCoreConfig.isDevBuild()) FileLog.e("успешный ответ: " + resultText);
    ...
    private static Content buildContent(
        ...
        if (inputBitmap != null || ocr) {
            ...
            if (YuurigramCoreConfig.isDevBuild()) FileLog.e("промпт: " + imagePrompt);
        } else if (translateText) { // Message translation
            String lang = capitalFirst(languageName(YuurigramMessagesConfig.INSTANCE.getTranslationTargetGemini()));
            ...
            if (YuurigramCoreConfig.isDevBuild()) FileLog.e("промпт: " + translationPrompt);
            ...
            if (YuurigramCoreConfig.isDevBuild()) FileLog.e("промпт: " + voiceToTextPrompt);
            ...
            if (summarize) {
                ...
                String systemPrompt = YuurigramMessagesConfig.INSTANCE.getGeminiSystemPrompt();
                textPrompt = systemPrompt + " " + inputText;
            }

            content.addText(textPrompt);

            if (YuurigramCoreConfig.isDevBuild()) FileLog.e("промпт: " + textPrompt);
        }
