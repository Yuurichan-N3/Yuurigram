...
import id.idn.yuurigram.chats.ui.MessageMenuCompactView
...
object CGMessageMenuInjector {
    ...
    fun showGeminiItems(
        ...
        settingsCell.setOnClickListener {
            chatActivity.closeMenu()
            YuurigramPreferencesNavigator.createGemini(chatActivity)
        }
    ...
    fun injectClearFromCache(
        ...
        if (YuurigramMessagesConfig.showClearFromCache) {
    ...
    fun injectViewHistory(
        ...
        if (YuurigramMessagesConfig.showViewHistory) {
    ...
    fun injectSaveMessage(
        ...
        if (YuurigramMessagesConfig.showSaveMessage && chatMode != ChatActivity.MODE_SCHEDULED && !UserObject.isUserSelf(
                currentUser
            ) && !message.isSponsored
        ) {
    ...
    fun injectJSON(
        ...
        val show = force || (chatActivity != null && YuurigramMessagesConfig.showJSON &&
    ...
    fun removeItems(
        ...
        options.forEachIndexed { index, option ->
            val remove = when (option) {
                ...
                ChatActivity.OPTION_SAVE_TO_GALLERY, ChatActivity.OPTION_SAVE_TO_GALLERY2 -> noforwardsOrPaidMedia || !YuurigramMessagesConfig.showSaveToGallery
                ChatActivity.OPTION_SAVE_TO_DOWNLOADS_OR_MUSIC -> noforwardsOrPaidMedia || !YuurigramMessagesConfig.showSaveToDownloads
                ChatActivity.OPTION_SHARE -> noforwardsOrPaidMedia || !YuurigramMessagesConfig.showShare
                ...
                ChatActivityHelper.OPTION_COPY_PHOTO ->
                    noforwardsOrPaidMedia || !YuurigramMessagesConfig.showCopyPhoto || (MessageMenuCompactView.allowCompactStyle() && primaryMessageText == null)
                ChatActivityHelper.OPTION_COPY_PHOTO_AS_STICKER ->
                    noforwardsOrPaidMedia || !YuurigramMessagesConfig.showCopyPhotoAsSticker || (MessageMenuCompactView.allowCompactStyle() && primaryMessageText == null)

                ChatActivity.OPTION_FORWARD ->
                    noforwardsOrPaidMedia || !YuurigramMessagesConfig.showForward || MessageMenuCompactView.allowCompactStyle()

                ChatActivityHelper.OPTION_FORWARD_WO_AUTHOR ->
                    noforwardsOrPaidMedia || !YuurigramMessagesConfig.showForwardWoAuthorship || MessageMenuCompactView.allowCompactStyle()
    ...
    fun showMessageMenuItemsConfigurator(fragment: BaseFragment) {
        val menuItems = listOf(
            MenuItemConfig(
                ...
                { YuurigramMessagesConfig.showSaveForNotifications },
                { YuurigramMessagesConfig.showSaveForNotifications = !YuurigramMessagesConfig.showSaveForNotifications },
                true
            ),
            MenuItemConfig(
                getString(R.string.CP_GeminiAI_Header),
                R.drawable.magic_stick_solar,
                { YuurigramMessagesConfig.showGemini },
                { YuurigramMessagesConfig.showGemini = !YuurigramMessagesConfig.showGemini },
                true
            ),
            MenuItemConfig(
                getString(R.string.Reply),
                R.drawable.menu_reply,
                { YuurigramMessagesConfig.showReply },
                { YuurigramMessagesConfig.showReply = !YuurigramMessagesConfig.showReply }
            ),
            MenuItemConfig(
                getString(R.string.SaveToGallery),
                R.drawable.msg_gallery,
                { YuurigramMessagesConfig.showSaveToGallery },
                { YuurigramMessagesConfig.showSaveToGallery = !YuurigramMessagesConfig.showSaveToGallery }
            ),
            MenuItemConfig(
                getString(R.string.CG_CopyPhoto),
                R.drawable.msg_copy,
                { YuurigramMessagesConfig.showCopyPhoto },
                { YuurigramMessagesConfig.showCopyPhoto = !YuurigramMessagesConfig.showCopyPhoto }
            ),
            MenuItemConfig(
                getString(R.string.CG_CopyPhotoAsSticker),
                R.drawable.msg_copy,
                { YuurigramMessagesConfig.showCopyPhotoAsSticker },
                { YuurigramMessagesConfig.showCopyPhotoAsSticker = !YuurigramMessagesConfig.showCopyPhotoAsSticker }
            ),
            MenuItemConfig(
                getString(R.string.SaveToDownloads),
                R.drawable.msg_download,
                { YuurigramMessagesConfig.showSaveToDownloads },
                { YuurigramMessagesConfig.showSaveToDownloads = !YuurigramMessagesConfig.showSaveToDownloads }
            ),
            MenuItemConfig(
                getString(R.string.ShareFile),
                R.drawable.msg_shareout,
                { YuurigramMessagesConfig.showShare },
                { YuurigramMessagesConfig.showShare = !YuurigramMessagesConfig.showShare }
            ),
            MenuItemConfig(
                getString(R.string.CG_ClearFromCache),
                R.drawable.msg_clear,
                { YuurigramMessagesConfig.showClearFromCache },
                { YuurigramMessagesConfig.showClearFromCache = !YuurigramMessagesConfig.showClearFromCache }
            ),
            MenuItemConfig(
                getString(R.string.Forward),
                R.drawable.msg_forward,
                { YuurigramMessagesConfig.showForward },
                { YuurigramMessagesConfig.showForward = !YuurigramMessagesConfig.showForward }
            ),
            MenuItemConfig(
                getString(R.string.Forward) + " " + getString(R.string.CG_Without_Authorship),
                R.drawable.msg_forward,
                { YuurigramMessagesConfig.showForwardWoAuthorship },
                { YuurigramMessagesConfig.showForwardWoAuthorship = !YuurigramMessagesConfig.showForwardWoAuthorship }
            ),
            MenuItemConfig(
                getString(R.string.AvatarPreviewSearchMessages),
                R.drawable.msg_search,
                { YuurigramMessagesConfig.showViewHistory },
                { YuurigramMessagesConfig.showViewHistory = !YuurigramMessagesConfig.showViewHistory }
            ),
            MenuItemConfig(
                getString(R.string.CG_ToSaved),
                R.drawable.msg_saved,
                { YuurigramMessagesConfig.showSaveMessage },
                { YuurigramMessagesConfig.showSaveMessage = !YuurigramMessagesConfig.showSaveMessage }
            ),
            MenuItemConfig(
                getString(R.string.ReportChat),
                R.drawable.msg_report,
                { YuurigramMessagesConfig.showReport },
                { YuurigramMessagesConfig.showReport = !YuurigramMessagesConfig.showReport }
            ),
            MenuItemConfig(
                "JSON",
                R.drawable.msg_info,
                { YuurigramMessagesConfig.showJSON },
                { YuurigramMessagesConfig.showJSON = !YuurigramMessagesConfig.showJSON }
            )
        )
