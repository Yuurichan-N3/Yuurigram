...
public class CameraTypeSelector extends LinearLayout {
    ...
    int currentIcon = YuurigramCameraConfig.INSTANCE.getCameraType();
    ...
    public CameraTypeSelector(Context context) {
        ...
        int selectedButton = YuurigramCameraConfig.INSTANCE.getCameraType();
        ...
        if (animate) {
            ...
            animator.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    currentIcon = YuurigramCameraConfig.INSTANCE.getCameraType();
