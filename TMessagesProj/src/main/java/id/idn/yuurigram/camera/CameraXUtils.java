...
public class CameraXUtils {
    ...
    public static boolean isCurrentCameraCameraX() {
        return isCameraXSupported() && YuurigramCameraConfig.INSTANCE.getCameraType() == YuurigramCameraConfig.CAMERA_X;
    }
    ...
    /*public static int getDefaultCamera() { // Used for Config
        return isCameraXSupported() ? YuurigramCameraConfig.CAMERA_X : YuurigramCameraConfig.TELEGRAM_CAMERA;
    }*/
    ...
    public static void loadSuggestedResolution() {
        ...
        getAvailableVideoSizes().values().stream()
                ...
                .ifPresent(height -> {
                    ...
                    if (YuurigramCameraConfig.INSTANCE.getCameraResolution() == -1 || YuurigramCameraConfig.INSTANCE.getCameraResolution() > maxResolution || YuurigramCameraConfig.INSTANCE.getCameraResolution() < minResolution) {
                        YuurigramCameraConfig.INSTANCE.setCameraResolution(
